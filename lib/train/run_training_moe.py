...
def run_training(script_name, config_name, cudnn_benchmark=True, local_rank=-1, save_dir=None, base_seed=None,
    ...
    expr_module = importlib.import_module('lib.train.train_script_moe')
...
def main():
    ...
    parser.add_argument('--script', default='moe',type=str, required=True, help='Name of the train script.')
    parser.add_argument('--config', default='moe', type=str, required=True, help="Name of the config file.")
    parser.add_argument('--cudnn_benchmark', type=bool, default=True, help='Set cudnn benchmark on (1) or off (0) (default is on).')
    parser.add_argument('--local_rank', default=-1, type=int, help='node rank for distributed training')
    parser.add_argument('--save_dir',default="/root/workdir/transmdot/output/", type=str, help='the directory to save checkpoints and logs')
