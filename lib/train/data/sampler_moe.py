...
class TrackingSamplerMoE(torch.utils.data.Dataset):
    ...
    def getitem(self):
        ...
        while not valid:
            ...
            try:
                ...
                # add nl
                template_nl = meta_obj_train.get('object_nlp')
                # print(template_nl)
                search_nl_token_ids, search_nl_token_masks = self.extract_token_from_nlp(template_nl, 40) # 最长40

                # print(search_nl_token_ids)
                # print(search_nl_token_masks)
                ...
                data = TensorDict({'template_images': template_frames,
                                   ...
                                   'nlp_message': meta_obj_train.get('object_nlp'),          # 返回加入nlp信息
