...
def run_training(script_name, config_name, cudnn_benchmark=True, local_rank=-1, save_dir=None, base_seed=None,
    ...
    expr_module = importlib.import_module('lib.train.train_script_os_moe_lan')
...
def main():
    ...
    parser.add_argument('--config', default='moe_lan', type=str, required=True, help="Name of the config file.")
