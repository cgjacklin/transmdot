...
from lib.train.data import sampler, opencv_loader, processing, LTRLoader, sampler_mdot
...
def names2datasets(name_list: list, settings, image_loader):
    ...
    for name in name_list:
        assert name in ["LASOT", "LASOT_VAL", "GOT10K_vottrain", "GOT10K_votval", "GOT10K_train_full", "GOT10K_official_val",
