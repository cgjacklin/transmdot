...
# network related
from lib.models.ostrack import build_ostrack, build_ostrack_three, build_ostrack_moe
# forward propagation related
from lib.train.actors import OSTrackActor, OSTrackActorMDOT, OSTrackActorThreeMDOT, OSTrackActorMOE
# for import modules
import importlib
...
def run(settings):
    ...
    actor = OSTrackActorMOE(net=net, objective=objective, loss_weight=loss_weight, settings=settings, cfg=cfg)
    # if settings.script_name == "ostrack":
    #     focal_loss = FocalLoss()
