...
from lib.models.ostrack import build_ostrack_moe_lan
...
class OSTrackMoELan(BaseTracker):
    def __init__(self, params, dataset_name):
        super(OSTrackMoELan, self).__init__(params)
        network = build_ostrack_moe_lan(params.cfg, training=False)
